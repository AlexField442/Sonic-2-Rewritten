...
## Objects
* Changed `priority` to now directly points to the sprite queue, rather than being calculated. This considerably simplifies DisplaySprite/2, but also requires all objects to explicitly declare their priority value.
